...
<img align="right" src="images/me.jpg" alt="моя фотография" style="height: 250px; object-fit: contain">
...
<ul>
    ...
    <li>Работал в Agile-командах</li>
    <li>Дружу с SOLID, DRY, YAGNI, KISS (читал Чистый код и Чистую архитектуру Роберта Мартина)</li>
    <li>Знаю теорию тестирования; писал автотесты с помощью JUnit, Mockito, Pytest, Postman, k6</li>
    <li>В свободное время изучаю Kali Linux и кибербезопасность, работаю с Raspberry Pi</li>
...
<ul>
    <li>
        ...
        <ul>
        <li>Разработал проект геотаргетинга лендинга Музыки с нуля: теперь контент главной страницы сервиса зависит от города пользователя.</li>
        <li>Участвовал в переносе контент-админки со старой библиотеки на новую, улучшая UX контент-менеджеров.</li>
        <li>Занимался добавлением новых фич и рефакторингом кода в монолите и микросервисах.</li>
        <li>Покрывал код автотестами: unit и e2e. Работал с тестами в CI/CD.</li>
        <li>Самостоятельно выкатывал новые фичи с использованием фича-флагов. Мониторил состояние микросервисов.</li>
        </ul>
...
<hr/>
<a href="https://github.com/andreydem0505/WalletWatcher">Бот</a>, отслеживающий транзакции криптовалютных кошельков на бирже Hyperliquid <b>(Python)</b>
<hr/>
<details>
<summary>
...
<img width="300" src="images/finam-post.png" alt="Пост новости">
</details>
<hr/>
<details>
...
<details>
    ...
    <img src="images/travelparse-mobile1.png" alt="скриншот мобильного приложения" style="height: 300px; object-fit: contain"/>
    <img src="images/travelparse-mobile2.png" alt="скриншот мобильного приложения" style="height: 300px; object-fit: contain"/>
    <img src="images/travelparse-site.png" alt="скриншот сайта" style="height: 300px; object-fit: contain"/>
...
<details>
    ...
    <img src="images/terra-cognita1.png" alt="скриншот сайта" style="height: 300px; object-fit: contain"/>
    <img src="images/terra-cognita2.png" alt="скриншот сайта" style="height: 300px; object-fit: contain"/>
    <br>Написан на хакатоне за 3 дня 
</details>
<hr/>
<details>
<summary><a href="https://github.com/andreydem0505/Songwriter">Скрипт</a>, составляющий мелодию на синтезаторе для FL Studio <b>(Python)</b></summary>
<br>
<img width="600" src="images/music-project.png" alt="Проект">
<img width="600" src="images/fl.png" alt="Результат">
</details>
<hr/>
